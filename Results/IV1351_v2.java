...
public class IV1351 {
    ...
    /**
     * Try to print out all instruments in the system as a table from database
     */
    ...
    /**
     * This function will find all of the instruments which are rented and which students are renting them. 
     */
    public static void instruments_rented() {

        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);  //try connect to DB
                   Statement stmt = conn.createStatement();
